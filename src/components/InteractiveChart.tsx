...
const InteractiveChart = ({ data, lines, height = 350, autoFollow = true }: InteractiveChartProps) => {
  ...
  useEffect(() => {
    if (data.length > prevDataLengthRef.current && isFollowing) {
      // New data arrived, scroll to show latest
      const currentRange = brushEndIndex - brushStartIndex;
  ...
  return (
    <div className="space-y-3 sm:space-y-4 w-full overflow-hidden">
      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center gap-1 sm:gap-2 flex-wrap">
          ...
          <Button
            ...
            className="gap-1 text-xs sm:text-sm px-2 sm:px-3 ml-auto"
          >
      ...
      <div ref={chartContainerRef} className="touch-none w-full -mx-1 sm:mx-0">
