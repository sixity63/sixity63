...
const Dashboard = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-[80vh] flex items-center justify-center bg-neumorphic">
      ...
      <div className="max-w-9xl mx-auto bg-neumorphic rounded-3xl shadow-[12px_12px_24px_hsl(var(--neumorphic-shadow-dark)),-12px_-12px_24px_hsl(var(--neumorphic-shadow-light))] p-3 md:p-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            <div className="w-12 h-12 rounded-full bg-neumorphic shadow-[4px_4px_8px_hsl(var(--neumorphic-shadow-dark)),-4px_-4px_8px_hsl(var(--neumorphic-shadow-light))] flex items-center justify-center">
          ...
          {devices.length > 0 && (
            <div className="flex justify-end">
              <Select value={selectedDeviceId} onValueChange={setSelectedDeviceId}>
                <SelectTrigger className="w-auto min-w-[150px] bg-neumorphic border-none shadow-[inset_2px_2px_4px_hsl(var(--neumorphic-shadow-dark)),inset_-2px_-2px_4px_hsl(var(--neumorphic-shadow-light))] text-foreground">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-4">
          {sensorCards.map((card, index) => (
            <div
              key={index}
              className="bg-neumorphic rounded-2xl shadow-[6px_6px_12px_hsl(var(--neumorphic-shadow-dark)),-6px_-6px_12px_hsl(var(--neumorphic-shadow-light))] p-4 md:p-5 transition-all hover:shadow-[8px_8px_16px_hsl(var(--neumorphic-shadow-dark)),-8px_-8px_16px_hsl(var(--neumorphic-shadow-light))]"
            >
              {/* Icon */}
        ...
        <div className="mb-3">
          ...
          {devices.length > 0 ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {devices.map((device) => {
                ...
                return (
                  <div
                    key={device.id}
                    className="bg-neumorphic rounded-xl shadow-[inset_4px_4px_8px_hsl(var(--neumorphic-shadow-dark)),inset_-4px_-4px_8px_hsl(var(--neumorphic-shadow-light))] p-4 flex items-center gap-4"
                  >
                    {/* Device Icon */}
                    <div className="w-10 h-10 rounded-lg bg-neumorphic shadow-[3px_3px_6px_hsl(var(--neumorphic-shadow-dark)),-3px_-3px_6px_hsl(var(--neumorphic-shadow-light))] flex items-center justify-center">
            ...
            /* Empty State */
            <div className="bg-neumorphic rounded-2xl shadow-[inset_6px_6px_12px_hsl(var(--neumorphic-shadow-dark)),inset_-6px_-6px_12px_hsl(var(--neumorphic-shadow-light))] p-8 text-center">
              <div className="w-16 h-16 rounded-full bg-neumorphic shadow-[4px_4px_8px_hsl(var(--neumorphic-shadow-dark)),-4px_-4px_8px_hsl(var(--neumorphic-shadow-light))] flex items-center justify-center mx-auto mb-4">
